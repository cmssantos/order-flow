...
public record CreateProductRequest(string Name, string Sku, decimal Price, string Currency);
public record UpdateProductRequest(string Name, string Sku, decimal Price, string Currency);
...
public static class ProductEndpoints
{
    public static void MapProductEndpoints(this IEndpointRouteBuilder app)
    {
        ...
        {
            var command = new UpdateProductCommand(id, request.Name, request.Sku, request.Price, request.Currency);
